...
class AdminContactController extends Controller
{
     ...
     * @var string
     */
    protected $createSuccessMessage = "Contact Created Successfully!";
     ...
     * @var string
     */
    protected $editSuccessMessage = "Contact Edited Successfully!";
     ...
     * @var string
     */
    protected $deleteSuccessMessage = "Contact Deleted Successfully";
    ...
    public function store(Request $request)
    {
        ...
        if($request->file('profile_picture'))
        {
            ...
            $request->file('profile_picture')->move(base_path() . '/public/uploads/contacts/', $imageName);
    ...
    public function getTableData()
    {
        return Datatables::of($this->repository->getForDataTable())
            ...
            {
                return  Html::image('/uploads/contacts/'.$item->profile_picture, $item->profile_picture, ['width' => 60, 'height' => 60]);
            })
