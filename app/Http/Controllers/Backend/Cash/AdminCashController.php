...
class AdminCashController extends Controller
{
     ...
     * @var string
     */
    protected $createSuccessMessage = "Cash Created Successfully!";
     ...
     * @var string
     */
    protected $editSuccessMessage = "Cash  Edited Successfully!";
     ...
     * @var string
     */
    protected $deleteSuccessMessage = "Cash  Deleted Successfully";
	...
	{
        $this->repository   = new EloquentCashRepository;
        $this->companyModel = new Cash;
	}
