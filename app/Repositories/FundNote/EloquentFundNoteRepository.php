<?php namespace App\Repositories\FundNote;
...
class EloquentFundNoteRepository extends DbRepository
{
	/**
	 * Event Model
	 * 
	 ...
	 */
	public $moduleViews = [
		'listView' 		=> 'fund-note.index',
		'createView' 	=> 'fund-note.create',
		'editView' 		=> 'fund-note.edit',
		'deleteView' 	=> 'fund-note.destroy',
	];
