...
@section ('title', isset($title) ? $title : 'Edit Document Category')
            ...
            <div class="box-header with-border">
                <h3 class="box-title">Entity</h3>
                    <div class="box-tools pull-right">
                        @include('common.document-category.header-buttons', ['listRoute' => $repository->getActionRoute('listRoute'), 'createRoute' => $repository->getActionRoute('createRoute')])
                    </div>
            </div>

            @include('common.document-category.form')
