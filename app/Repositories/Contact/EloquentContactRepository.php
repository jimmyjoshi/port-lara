...
class EloquentContactRepository extends DbRepository
{
	/**
	 * Event Model
	 * 
	...
	public $moduleViews = [
		...
		'createView' 	=> 'contact.create',
		'editView' 		=> 'contact.edit',
		'deleteView' 	=> 'contact.destroy',
	];
