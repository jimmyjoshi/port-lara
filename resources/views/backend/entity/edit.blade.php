            ...
            <div class="box-header with-border">
                <h3 class="box-title">Entity</h3>
                    <div class="box-tools pull-right">
                        @include('common.entity.header-buttons', ['listRoute' => $repository->getActionRoute('listRoute'), 'createRoute' => $repository->getActionRoute('createRoute')])
                    </div>
            </div>

            @include('common.entity.form')
