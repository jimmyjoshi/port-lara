            ...
            <div class="box-header with-border">
                <h3 class="box-title">Tax Document</h3>
                    <div class="box-tools pull-right">
                        @include('common.fund-document.header-buttons', ['listRoute' => $repository->getActionRoute('listRoute'), 'createRoute' => $repository->getActionRoute('createRoute')])
                    </div>
            </div>

            @include('common.fund-document.form')
